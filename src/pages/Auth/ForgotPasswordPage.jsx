  ...
  if (sent) {
    return (
      ...
      >
        ...
        <Link
          to="/login"
          className="inline-flex items-center gap-2 text-[0.875rem] font-semibold text-[#233E58] hover:text-[#1C3247] transition-colors"
        >
          <ArrowLeft size={16} />
          Volver al login
        </Link>
  ...
  return (
    ...
    >
      ...
      <div className="w-12 h-12 rounded-2xl flex items-center justify-center mb-5 bg-[#233E581A] border border-[#233E5833]">
        <Mail size={22} className="text-[#233E58]" />
      </div>
      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-4">
        ...
        <button
          type="submit"
          disabled={loading}
          className="w-full rounded-2xl py-4 text-[0.9375rem] font-bold text-white bg-[#233E58] hover:bg-[#1C3247] disabled:opacity-50 disabled:cursor-not-allowed transition-colors duration-150"
      ...
      <div className="text-center mt-6">
        <Link
          to="/login"
          className="inline-flex items-center gap-1.5 text-[0.8125rem] text-[#64748B] hover:text-[#233E58] transition-colors"
        >
          <ArrowLeft size={14} />
          Volver al login
        </Link>

...
export default function SideNavBar({ user, onLogout }) {
  ...
  return (
    ...
    >
      {/* Logo — variante Business si la cuenta es business (regla de diseño alyto-ux) */}
      <div style={{ padding: '24px 20px 20px', display: 'flex', flexDirection: 'column', gap: 4 }}>
        <img
          ...
          alt={(user?.accountType === 'business' || user?.kybStatus === 'approved') ? 'Alyto Business' : 'Alyto Wallet 2.0'}

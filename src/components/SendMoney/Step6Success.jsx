  ...
  return (
    <div className="flex flex-col items-center gap-6 px-4 pb-6 pt-4">
      ...
      <div className="text-center">
        <h2 className="text-[1.375rem] font-extrabold text-[#0F172A] mb-1">
        ...
        <div className="px-5 py-3 divide-y divide-[#E2E8F0]">
          {[
            ...
            <div key={label} className="flex justify-between items-center py-2.5">
              ...
              <span className="text-[0.8125rem] font-semibold text-[#0F172A]">{value || '—'}</span>
            </div>
          ))}
        </div>
      </div>
      ...
      {/* ── ID de comprobante ── */}
      <div className="w-full bg-[#F8FAFC] border border-[#E2E8F0] rounded-xl px-4 py-3">

...
import { BarChart2, Layers, ArrowLeft, ShieldCheck, TrendingUp, Wallet, Building2, QrCode, Banknote, AlertCircle, ShieldAlert, Settings2, AlertTriangle, CheckCircle2, X, Bell, UserPlus, ArrowUpRight, ArrowDownLeft, ArrowRightLeft, FileText, Send, Shield as ShieldIcon, CheckCheck, Loader2, Users, Percent, Landmark, Radio } from 'lucide-react'
  ...
  return (
    <div className="min-h-screen bg-[#0F1628] font-sans flex">
      ...
      >
        ...
        <SidebarLink to="/admin/anchor"     icon={Radio}      label="Anchor · Salud" />
